...
import { useReservation, useUpdateReservation, useDeleteReservation } from "../../../hooks/useReservations";
...
export default function EditReservationPage({ params }) {
  ...
  // Rezervasyon verisi yüklendiğinde form alanlarını doldur
  useEffect(() => {
    if (reservation) {
      ...
      if (reservation.finish) {
        const date = new Date(reservation.finish);
      ...
      setFormData({
        ...
        house_id: reservation.house_id?.toString() || "",
        worker_id: reservation.worker_id?.toString() || "",
        start: startDate,
        finish: finishDate,
    ...
    updateReservation(
      { id, data: reservationData },
      {
        ...
        onError: (error) => {
          ...
          alert("Rezervasyon güncellenirken bir hata oluştu. Lütfen tekrar deneyin.");
        }
      }
    );
  };
  ...
  if (reservationLoading || housesLoading || workersLoading) {
    return <div className="container mx-auto p-4">Yükleniyor...</div>;
  }
  
  if (!reservation) {
    return <div className="container mx-auto p-4">Rezervasyon bulunamadı.</div>;
  }
      ...
      <div className="container mx-auto px-4 py-2 sm:py-4">
        <div className="max-w-2xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4 sm:mb-6">
            <h1 className="text-xl sm:text-2xl font-bold">Rezervasyon Düzenle</h1>
          ...
          {showDeleteConfirm && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white p-6 rounded-lg shadow-xl max-w-sm w-full">
                ...
                <p className="mb-4">Bu rezervasyonu silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.</p>
